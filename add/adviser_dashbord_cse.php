<?php
session_start();
if ($_SESSION['role'] != 'adviser' || $_SESSION['department_id'] != 2) { // Assuming department_id for CSE is 2
...
$assigned_class_ids = [
    'kali' => 4, // Example CSE class IDs
    'uma' => 16, // Example CSE class IDs
    'smith' => 12, // Example CSE class IDs
    'vadugunadhan' => 13 // Example CSE class IDs
];
...
<head>
    ...
    <title>Adviser Dashboard - CSE Department</title>
...
<body>
    <header>
        <h1>Adviser Dashboard - CSE Department</h1>
